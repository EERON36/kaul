> Historical snapshot preserved on 4 September 2026. All status, deployment,
> dependency, and validation statements below describe the 23 August review;
> they are not current operational evidence. Use [the current project state](../../PROJECT_STATE.md)
> and the authoritative milestone/security documents for present decisions.
